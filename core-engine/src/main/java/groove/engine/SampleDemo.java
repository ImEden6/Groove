...
public final class SampleDemo {
    public static void main(String[] args) throws Exception {
        ...
        Pattern drums=Pattern.polymeter(8,k,h,s,h,k,h,r,h);
        Pattern bass=Pattern.tone(new Tone(Tone.Wave.SINE,Pitch.hz("C2"),.2,0,1200)).euclid(8,3,0);
        Score score=Score.compile(Pattern.stack(drums,bass),new Transport(48000,120,4),4,bank);
